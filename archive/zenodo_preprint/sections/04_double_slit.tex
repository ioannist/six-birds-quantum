...
Figure~\ref{fig:ds-patterns} shows the screen patterns for several values of~$|\gamma|$ in a far-field toy model.
...
\begin{figure}[t]
  ...
  \caption{Extracted visibility versus record overlap magnitude $|\gamma|$ in the toy model.}
